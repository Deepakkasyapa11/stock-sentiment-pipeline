...
The system follows a modular "Producer-Consumer" pattern, designed for high throughput and horizontal scalability. The system is split into three distinct layers, unified under a high-performance `src/` directory structure:
